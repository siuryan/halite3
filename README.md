...
## Unit Testing
Write unit tests in the `tests` directory, and run `./unittest.sh` to check unit tests.

## Run
To run bots in games against each other, run `python3 run.py` with the correct arguments.
